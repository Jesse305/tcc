...
<div class="form-group row">
  ...
  <div class="col-md-9">
    <input class="form-control" type="text" name="nome" id="nome" value="{{ old('nome', isset($cliente) ? $cliente->nome : '') }}" maxlength="200" required>
    @if($errors->has('nome'))
...
<div class="form-group row">
  ...
  <div class="col-md-9">
    <input class="form-control cpf" type="text" name="cpf" id="cpf" value="{{ old('cpf', isset($cliente) ? $cliente->cpf : '') }}" required>
    @if($errors->has('cpf'))
...
<div class="form-group row">
  ...
  <div class="col-md-9">
    <input class="form-control telefone" type="text" name="telefone" id="telefone" value="{{ old('telefone', isset($cliente) ? $cliente->telefone : '') }}" required>
...
<div class="form-group row">
  ...
  <div class="col-md-9">
    <input class="form-control" type="text" name="email" id="email" value="{{ old('email', isset($cliente) ? $cliente->email : '' ) }}">
    @if($errors->has('email'))
